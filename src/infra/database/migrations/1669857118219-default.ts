...
export class default1669857118219 implements MigrationInterface {
    name = 'default1669857118219'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "block" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "title" text NOT NULL, "description" text NOT NULL, "cover" text, "createdAt" date, "created_by" character varying NOT NULL, CONSTRAINT "PK_d0925763efb591c2e2ffb267572" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "class" ("id" SERIAL NOT NULL, "order" integer NOT NULL, "name" character varying NOT NULL, "description" character varying NOT NULL, "cover" character varying, "created_by" character varying, "updated_by" character varying, "blockId" uuid, CONSTRAINT "PK_0b9024d21bdfba8b1bd1c300eae" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "assignment" ("id" SERIAL NOT NULL, "title" character varying NOT NULL, "description" character varying NOT NULL, "kind" text NOT NULL, "file" character varying, "answer" character varying, "created_by" character varying, "updated_by" character varying, CONSTRAINT "PK_43c2f5a3859f54cedafb270f37e" PRIMARY KEY ("id"))`);
